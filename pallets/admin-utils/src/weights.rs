...
pub trait WeightInfo {
	...
	fn sudo_set_min_trade_delay() -> Weight;
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	/// Storage: `SubtensorModule::MinTradeDelay` (r:0 w:1)
	/// Proof: `SubtensorModule::MinTradeDelay` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	fn sudo_set_min_trade_delay() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
		//  Estimated: `0`
