"""In-memory caching for the transport: a small LRU cache plus an async
fetch de-duplicator (`cached_fetcher`) that lets concurrent calls with the
same arguments share a single in-flight request.
"""
