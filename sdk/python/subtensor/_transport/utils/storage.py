...
class StorageKey:
    ...
    def create_from_storage_function_batch(
        ...
        metadata_storage_function = metadata_pallet.get_storage_function(storage_function)
        ...
        for params in params_list:
            ...
            for idx, param in enumerate(params):
                if type(param) is ScaleBytes:
                    ...
                    param = cls._convert_storage_parameter(param_types[idx], param, ss58_format)
    ...
    @staticmethod
    def _convert_storage_parameter(scale_type: str, value: Any, ss58_format: Optional[int]):
    ...
    def convert_storage_parameter(self, scale_type: str, value: Any):
        return self._convert_storage_parameter(scale_type, value, self.runtime_config.ss58_format)
    ...
    def generate(self) -> bytes:
        ...
        storage_hash = xxh128(metadata_pallet.value["storage"]["prefix"].encode()) + xxh128(
            self.storage_function.encode()
        )
