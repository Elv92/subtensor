"""`subtensor crowd`: crowdloan commands."""
...
app = typer.Typer(no_args_is_help=True, help="Crowdloan queries (mutations use `subtensor tx`).")
...
def list_crowdloans(ctx: typer.Context):
    ...
    if not rows:
        ...
        return
    table_rows = [[r["id"], r["creator"], r["raised_tao"], r["cap_tao"], r["finalized"]] for r in rows]
