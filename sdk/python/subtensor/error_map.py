...
Every error name in the generated catalog (subtensor/_generated/errors.py) is
...
only to avoid a circular import; import it from ``subtensor.result``.
...
NAME_TO_CODE: dict[str, ErrorCode] = {
    ...
    "ColdkeySwapDisputed": _C.TOO_EARLY,
    ...
    "NegativeSigmoidSteepness": _C.NOT_AUTHORIZED,
