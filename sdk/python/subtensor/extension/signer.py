"""Extension-backed signers implementing the SDK :class:`~subtensor.signing.Signer` protocol."""
...
def account_crypto_type(account_type: str) -> int:
    ...
    if normalized not in _ACCOUNT_TYPE_TO_CRYPTO:
        ...
        raise ValueError(f"unsupported extension account type {account_type!r}; expected {supported}")
...
class ExtensionSigner:
    ...
    flows such as ``subtensor wallet sign``.
    """
