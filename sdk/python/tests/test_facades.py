...
from subtensor.client import Client
from subtensor.namespaces import Balances, Neurons, Staking, Subnets
from subtensor.snapshot import Snapshot
from subtensor.sync import _NAMESPACES, SyncClient, SyncSnapshot, _SyncNamespace
...
def test_sync_facade_mirrors_async_surface(async_cls, sync_cls):
    ...
    for name, fn in surface.items():
        ...
        assert _param_names(sync_fn) == _param_names(
            fn
